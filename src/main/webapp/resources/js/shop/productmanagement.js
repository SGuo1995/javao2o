$(function () {
    // 获取此店铺下的商品列表的URL
    var listUrl = '/javao2o/shopadmin/getproductlistbyshop?pageIndex=1&pageSize=999';
    // 商品下架URL
    var statusUrl = '/javao2o/shopadmin/modifyproduct';
    getList();
        ...
        .on(
            ...
            function (e) {
                ...
                if (target.hasClass('edit')) {
                    ...
                    window.location.href = '/javao2o/shopadmin/productoperation?productId='
                    ...
                    window.location.href = '/javao2o/frontend/productdetail?productId='
                        + e.currentTarget.dataset.id;
                }
            });
