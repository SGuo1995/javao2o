$(function () {
    ...
    var pageSize = 3;
    // 列出商品列表的URL
    var listUrl = '/javao2o/frontend/listproductsbyshop';
    // 默认的页码
    var pageNum = 1;
    // 从地址栏里获取ShopId
    ...
    var searchDivUrl = '/javao2o/frontend/listshopdetailpageinfo?shopId=' + shopId;
            ...
            if (data.success) {
                ...
                data.productList.map(function (item, index) {
                    html += '' + '<div class="card" data-product-id='
                        ...
                        + 'Updated</p>' + '<span>Click for detail</span>' + '</div>'
                        + '</div>';
                });
                // 将卡片集合添加到目标HTML组件里
