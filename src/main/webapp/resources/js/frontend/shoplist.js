$(function () {
    ...
    var pageSize = 3;
    // 获取店铺列表的URL
    var listUrl = '/javao2o/frontend/listshops';
    // 获取店铺类别列表以及区域列表的URL
    var searchDivUrl = '/javao2o/frontend/listshopspageinfo';
    // 页码
    var pageNum = 1;
    ...
    $('.shop-list').on('click', '.card', function (e) {
        ...
        window.location.href = '/javao2o/frontend/shopdetail?shopId=' + shopId;
    });
