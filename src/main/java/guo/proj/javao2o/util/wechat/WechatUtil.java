package guo.proj.javao2o.util.wechat;
...
public class WechatUtil {
    ...
    public static UserAccessToken getUserAccessToken(String code) throws IOException {
        // 测试号信息里的appId
        String appId = "wx9e2514412c4aefe5";
        log.debug("appId:" + appId);
        // 测试号信息里的appsecret
        String appsecret = "3b6b5d59ca5befefdc3c2ae603bb1f93";
        ...
        try {
            ...
            log.error("Failed to get user's accessToken: " + e.getMessage());
            e.printStackTrace();
        ...
        if (token == null) {
            log.error("Failed to get user's accessToken: ");
            return null;
        }
        return token;
    }
    ...
    /**
     * Get PersonInfo from WechatUser
     *
     * @param wechatUser
     * @return
     */
